...
var suo = {
    ...
    handleEvent: function(e) {
        ...
        switch (e.type) {
            ...
            case "mouseout":
                ...
                if (e.target.classList.contains("menu_hide") && !e.relatedTarget.classList.contains("menu_hide") && !e.relatedTarget.classList.contains("menupluscontent")) {
                    document.querySelector(".menupluscontent").style.display = "none";
                }
                break;
            case "mousemove":
    ...
    initExclusion: () => {
        ...
        for (var i = 0; i < _doms.length; i++) {
            ...
            for (var ii = 0; ii < _conf.length; ii++) {
                var _li = suo.domCreate2("li", {
                    setName: ["className"],
                    setValue: ["exclusion_list"]
                }, null, null, {
                    setName: ["id"],
                    setValue: [ii]
                }, _conf[ii]);
                var _btn = suo.domCreate2("span", {
                    setName: ["className"],
                    setValue: ["exclusion_del"]
                }, null, null, null, "x");
    ...
    createMoreText: function(_conf) {
        ...
        var dom = suo.domCreate2("div", {
            ...
            labelText = suo.domCreate2("label", {
                setName: ["className"],
                setValue: ["boxlabel"]
                ...
                switch(itemOBJ.type){
                    case"cryptocurrency":
                        ...
                        for(var i=0;i<itemOBJ.data.length;i++){
                            _ccul.appendChild(suo.domCreate2("li",{setName:["className"],setValue:["donate_ccli"],eclass:["donate_ccli-current"]},null,null,{setName:["id"],setValue:[i]},itemOBJ.data[i].name));
                        }
